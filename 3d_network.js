UInst3D(
  (backbone): FPN3D(
    (fpn_lateral2): Conv3d(64, 128, kernel_size=(1, 1, 1), stride=(1, 1, 1))
    (fpn_output2): Conv3d(128, 128, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
    (fpn_lateral3): Conv3d(128, 128, kernel_size=(1, 1, 1), stride=(1, 1, 1))
    (fpn_output3): Conv3d(128, 128, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
    (fpn_lateral4): Conv3d(256, 128, kernel_size=(1, 1, 1), stride=(1, 1, 1))
  ...
  (mask_branch): MaskBranch3D(
    ...
    (tower): Sequential(
      ...
      (4): Conv3d(128, 16, kernel_size=(1, 1, 1), stride=(1, 1, 1))
    )
  )
  (controller): Conv3d(128, 241, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
)
